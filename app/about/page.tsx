  ...
  return (
    <div className="flex flex-col gap-8 w-full">
      ...
      <p className=" text-zinc-600 dark:text-zinc-400">
        ...
        fullstack development, currently pursuing a bachelors degree in
        Information Technology. My expertise lies in building interactive web
        applications. Primarily working with technologies like JavaScript,
        Next.js, TypeScript and Node.
      </p>
      <p className=" text-zinc-600 dark:text-zinc-400">
      ...
      <p className=" text-zinc-600 dark:text-zinc-400">
        Beyond learning, I enjoy creating projects that both inspire and benefit
        fellow developers.
      </p>

      <div>
        <div className="py-6">
          <h2 className="text-2xl lg:text-3xl font-bold  pt-4">Usage</h2>
...
function ToolAndTech() {
  return (
    <div className="grid lg:grid-cols-2 lg:grid-rows-24 gap-4">
      {Object.entries(toolsAndTech).map(([key, val], index) => (
        <div
          className={`py-4 h-min ${
            index === 0 ? "lg:row-span-8" : "lg:row-span-5"
          } `}
          key={key}
        >
